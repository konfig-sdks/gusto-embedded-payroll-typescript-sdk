 ...
 * 
 * @export
 * @interface PaySchedulesUpdatePayScheduleRequest
 */
export interface PaySchedulesUpdatePayScheduleRequest {
    /**
     * The current version of the object. See the [versioning guide](https://docs.gusto.com/embedded-payroll/docs/versioning#object-layer) for information on how to use this field.
     * @type {string}
     * @memberof PaySchedulesUpdatePayScheduleRequest
     */
    'version': string;
    /**
     ...
     * @memberof PaySchedulesUpdatePayScheduleRequest
     */
    'frequency'?: PaySchedulesUpdatePayScheduleRequestFrequencyEnum;
    /**
...
type PaySchedulesUpdatePayScheduleRequestFrequencyEnum = 'Every week' | 'Every other week' | 'Twice per month' | 'Monthly'
