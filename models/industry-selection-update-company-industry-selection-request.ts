 ...
 * 
 * @export
 * @interface IndustrySelectionUpdateCompanyIndustrySelectionRequest
 */
export interface IndustrySelectionUpdateCompanyIndustrySelectionRequest {
    /**
     * Industry title
     * @type {string}
     * @memberof IndustrySelectionUpdateCompanyIndustrySelectionRequest
     */
    'title': string;
    /**
